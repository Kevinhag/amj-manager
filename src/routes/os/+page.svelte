<script>
  ...
  <main>
	<section>
	  ...
	  <div class="form-base">
		<h2>Clientes:</h2>
		<input type="text" id="search" placeholder="Pesquisar Cliente:" on:input={handleClientSearch} />
	  ...
	  <div class="part-list">
		...
		<button class="add-part" type="button" on:click={addPartList}>Adicionar</button>
	  </div>
	  ...
	  <div class="form-base">
		...
		<!-- textbox for observation field, do not be resizable -->
		<textarea  rows="4" cols="50" placeholder="Observações" bind:value={observacao} style="resize: none;"></textarea>
